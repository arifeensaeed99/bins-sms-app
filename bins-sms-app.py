                                                                ...
                                                                if email_provider_verifier(new_email) or is_uni_email(new_email):
                                                                    ...
                                                                    if new_phone:
                                                                        ...
                                                                        "Ting", "U.S. Cellular", "Verizon", "Virgin Mobile" ])
                                                                                    if new_carrier:
                                                                                        new_timezone = st.selectbox("Please select a timezone:", set(pytz.all_timezeones_set)) # list of all timezeones
                                                                                        if new_timezone:    
        ...
        if current_username and current_password:
            if result:
                ...
                if st.checkbox('Edit Timezone'):
                    ...
                    timezone = st.selectbox("Please select a new timezone:", set(pytz.all_timezeones_set)) 
                    if timezone:
